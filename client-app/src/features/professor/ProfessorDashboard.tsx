...
import BleonaPhoto from '../../app/Images/Bleona.jpg';
            ...
            <body>
                        ...
                        <ul className="d-flex align-items-center">
                            ...
                            <li className="nav-item dropdown pe-3">
                                ...
                                <a className="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                                    <img src={BleonaPhoto} alt="Profile" className="rounded-circle"></img>
                                    <span className="d-none d-md-block dropdown-toggle ps-2">{prof?.firstname + " " + prof?.lastname}</span>
                                </a>
                                        ...
                                        <div className="tab-content pt-2">
                                            ...
                                            <div className="tab-pane fade show active profile-overview" id="profile-overview">
                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="col-lg-9 col-md-8">{prof?.firstname + " " + prof?.lastname}</div>
                                                </div>

                                                <div className="row">
                                                    <div className="col-lg-3 col-md-4 label">Personal Number</div>
                                                    <div className="col-lg-9 col-md-8">{prof?.personalInfo.personalNumber}</div>
                                                </div>

                                                <div className="row">
                                                    <div className="col-lg-3 col-md-4 label">Date of Birth</div>
                                                    <div className="col-lg-9 col-md-8">{prof?.personalInfo.dateOfBirth}</div>
                                                </div>

                                                <div className="row">
                                                    <div className="col-lg-3 col-md-4 label">Gender</div>
                                                    <div className="col-lg-9 col-md-8">{prof?.personalInfo.gender}</div>
                                                </div>

                                                <div className="row">
                                                    <div className="col-lg-3 col-md-4 label">Address</div>
                                                    <div className="col-lg-9 col-md-8">{prof?.personalInfo.address}</div>
                                                </div>

                                                <div className="row">
                                                    <div className="col-lg-3 col-md-4 label">Phone</div>
                                                    <div className="col-lg-9 col-md-8">{prof?.personalInfo.phoneNumber}</div>
                                                </div>
                                                ...
                                                <div className="row">
                                                    <div className="col-lg-3 col-md-4 label">Martial Status</div>
                                                    <div className="col-lg-9 col-md-8">{prof?.personalInfo.maritalStatus}</div>
                                                </div>
                ...
                <footer id="footer" className="footer">
                    <div className="copyright">
                        &copy; Copyright <strong><span>DigitKosova</span></strong>. All Rights Reserved
                    </div>
